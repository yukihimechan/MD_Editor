...
const TableEditor = {
    ...
    showEditButton(table) {
        ...
        csvBtn.onclick = (e) => {
            ...
            if(window.showToast) window.showToast('CSVとしてクリップボードへコピーしました', 'info');
        };
        ...
        tsvBtn.onclick = (e) => {
            ...
            if(window.showToast) window.showToast('TSVとしてクリップボードへコピーしました', 'info');
        };
    ...
    copyRow(table, rowIndex) {
        ...
        if (typeof showToast === 'function') showToast("行をコピーしました", "success");
    },

    insertCopiedRow(table, rowIndex) {
        if (!this.copiedRowData) {
            if (typeof showToast === 'function') showToast("コピーされた行がありません", "warning");
            return;
        }
