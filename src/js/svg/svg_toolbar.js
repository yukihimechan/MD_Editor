...
class SVGMainToolbar extends SVGToolbarBase {
    constructor() {
        ...
        this.toolDefaults = {
            ...
            'capsule': { fill: 'none', stroke: '#000000', 'stroke-width': 1 },
        ...
        this.tools = [
            ...
            { id: 'capsule', label: '開始・終了（角丸）', icon: '<svg viewBox="0 0 24 24"><rect x="2" y="6" width="20" height="12" rx="6" fill="none" stroke="currentColor" stroke-width="2"/></svg>' },
    ...
    deleteCustomTool(toolId) {
        if (!confirm(t('confirm.deleteCustomTool').replace('${toolId}', toolId))) return;
