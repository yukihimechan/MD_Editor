...
const MathInlineEditor = {
    ...
    startEdit(mathElement, blockContainer) {
        ...
        if (this.dataLineEnd > this.dataLine) {
            ...
            const endLine = doc.line(endLineNum); // data-line-end corresponds to the actual inclusive end line in 1-based indexing for the occupied lines
